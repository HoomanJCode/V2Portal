...
- [x] Reject malformed persisted manual and typed outbounds, including VMess/VLESS, server-based, WireGuard, and stream-mapping shapes, before xray config generation.
