...
> * [x] ~~when i write v2portal test its show me an error~~ — Fixed: `v2portal test` without subcommand now shows usage help instead of crashing
...
> * [x] add auto compelete to this also the v2portal not have autocompelete with tab button on keyboard.
> * [x] if user type v2portal server start, its should start all and also for stop, and add restart to servers, also should know sv as server alias.
...
- [x] Phase 05 — CLI / TUI / service accept any ref (ad-hoc connect later removed → servers)
